-- VBS-148: Add is_blocked and consent_accepted_at to clientes_metricas view
-- for campaign filter-based recipient selection
...
-- Re-create alertas_semanales (depends on clientes_metricas)
